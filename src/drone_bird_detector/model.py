...
def download_model_if_needed() -> Path:
    ...
    local_model_path = MODEL_DIR / "drone_bird_detector.pth"
...
def load_model(device):
    ...
    # First load the labels so we know how many classes there are
    label_file = download_labels_if_needed()
    ...
    model = torchvision.models.detection.__dict__["FasterRCNN"](backbone = backbone, num_classes = len(labels), **kwargs)
